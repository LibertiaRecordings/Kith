  ...
  return (
    <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground">
      ...
      <section className="mt-8 bg-card rounded-2xl p-8 shadow-ultra-soft prose prose-invert max-w-none text-muted-foreground leading-relaxed text-lg">
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Information We Collect</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">How We Use Your Information</h2>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Sharing Your Information</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Your Choices</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Data Security</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Changes to This Policy</h2>
        <p>
