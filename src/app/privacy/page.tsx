...
export default function PrivacyPolicyPage() {
  return (
    <main id="main" className="container mx-auto px-6 py-10 min-h-screen bg-ink text-paper">
      <h1 className="text-4xl md:text-5xl font-display font-semibold tracking-tight text-paper">Privacy Policy</h1>
      <p className="mt-3 text-chrome font-mono">Your privacy is important to us.</p>
      ...
      <section className="mt-8 bg-graphite rounded-2xl p-8 shadow-ultra-soft prose prose-invert max-w-none text-chrome leading-relaxed text-lg">
        ...
        <h2 className="text-3xl font-display font-semibold text-paper mt-8 mb-4">Information We Collect</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-semibold text-paper mt-8 mb-4">How We Use Your Information</h2>
        ...
        <h2 className="text-3xl font-display font-semibold text-paper mt-8 mb-4">Sharing Your Information</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-semibold text-paper mt-8 mb-4">Your Choices</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-semibold text-paper mt-8 mb-4">Data Security</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-semibold text-paper mt-8 mb-4">Changes to This Policy</h2>
        <p>
