  ...
  const posts = [
    {
      ...
      body: `
        ...
        <h2 class="text-2xl font-hero text-foreground mt-8 mb-4">Understanding the Fade</h2>
        ...
        <h3 class="text-xl font-hero text-foreground mt-6 mb-3">Our Approach to Precision</h3>
    ...
    },
    {
      ...
      body: `
        ...
        <h2 class="text-2xl font-hero text-foreground mt-8 mb-4">Hydration is Key</h2>
        ...
        <h3 class="text-xl font-hero text-foreground mt-6 mb-3">Washing and Conditioning</h3>
  ...
  if (!post) {
    return (
      <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground">
        <h1 className="text-4xl md:text-5xl tracking-tight text-foreground">Post Not Found</h1>
  ...
  return (
    <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground">
      ...
      <article className="bg-card rounded-2xl p-8 shadow-ultra-soft">
        ...
        <h1 className="text-4xl md:text-5xl tracking-tight text-foreground mb-4">{post.title}</h1>
        ...
        {post.tags.length > 0 && (
          <div className="mt-8 pt-6 border-t border-muted-foreground/20">
            <h3 className="text-2xl font-hero text-foreground mb-3">Tags:</h3>
