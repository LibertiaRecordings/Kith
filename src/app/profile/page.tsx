...
export default async function ProfilePage() {
  ...
  if (error || !profileData) {
    ...
    return (
      <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground text-center">
        ...
        <p className="mt-3 text-muted-foreground font-display text-lg">Could not load profile data. Please try again later.</p>
      </main>
    );
  }
  ...
  return (
    <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground">
      ...
      <p className="mt-3 text-muted-foreground font-display text-lg text-center max-w-2xl mx-auto">Update your personal information.</p>
