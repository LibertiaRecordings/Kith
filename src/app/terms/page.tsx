  ...
  return (
    <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground">
      ...
      <section className="mt-8 bg-card rounded-2xl p-8 shadow-ultra-soft prose prose-invert max-w-none text-muted-foreground leading-relaxed text-lg">
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Appointments & Cancellations</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Pricing & Payments</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Gift Cards</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Loyalty Program</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Website Use</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Intellectual Property</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Limitation of Liability</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Governing Law</h2>
        <p>
          These Terms are governed by and construed in accordance with the laws of Alberta, Canada.
        </p>

        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Changes to Terms</h2>
        <p>
        ...
        <h2 className="text-3xl font-display font-medium text-foreground mt-8 mb-4">Contact Us</h2>
        <p>
