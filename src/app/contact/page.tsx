...
export default function ContactPage() {
  return (
    <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground">
      ...
      <p className="mt-3 text-muted-foreground font-mono text-sm">We're here to help you look your best.</p>
          ...
          <div className="bg-card rounded-2xl p-8 shadow-ultra-soft border border-muted-foreground/30">
            ...
            <div className="space-y-6 text-muted-foreground text-base">
              ...
              <div>
                ...
                <p className="text-sm">Street parking available directly in front of our shop. Please do not park in the private lot behind our building.</p>
              </div>
              <div>
                <p className="font-medium text-foreground text-lg">Accessibility</p>
                <p className="text-sm">Our barbershop is wheelchair accessible. Please contact us if you have specific accessibility needs.</p>
              </div>
            </div>
          </div>
        </div>

        {/* Right Column: Exterior Shop Photo */}
        <div className="rounded-2xl overflow-hidden shadow-ultra-soft border border-muted-foreground/30 h-[400px] lg:h-auto relative">
          <Image
