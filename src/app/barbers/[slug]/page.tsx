  ...
  if (!barber) {
    return (
      <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground">
        ...
        <p className="mt-3 text-muted-foreground font-mono text-sm">The barber you are looking for does not exist at Kith & Kin Barbershop Calgary.</p>
    ...
    <main id="main" className="container mx-auto px-6 py-16 min-h-screen bg-background text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1">
          ...
          <p className="text-muted-foreground font-mono text-lg mt-1">{barber.role} in Calgary</p>
